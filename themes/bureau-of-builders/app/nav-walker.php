...
//        }
        ...
        if (is_home()) {
            if ( $item->is_subitem ) {
                ...
                $item_html = str_replace( '<a', '<a  class="nav-link text-pink-700 tracking-three py-2 px-3 text-sm hover:text-black"', $item_html );
            }
        } else {
            if ( $item->is_subitem ) {
                $item_html = str_replace( '<a', '<a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"', $item_html );
                ...
                $item_html = str_replace( '<a', '<a  class="nav-link text-pink-700 tracking-three block py-2 lg:py-2 lg:px-3 text-sm hover:text-gray-700 lg:hover:text-white"', $item_html );
            }
        }
